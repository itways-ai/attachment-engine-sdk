...
@Slf4j
@Configuration
@ComponentScan("com.itways.assistant.upload_engine_sdk")
public class UploadAutoConfiguration {
    ...
    @PostConstruct
    public void print() {
        log.info("✅ Upload SDK configuration initialized");
    }

    @Bean
    public AmazonS3 amazonS3() {
        String endpoint = String.format("https://%s.r2.cloudflarestorage.com", cloudflareR2Config.getAccountId());
        BasicAWSCredentials credentials = new BasicAWSCredentials(cloudflareR2Config.getAccessKey(), cloudflareR2Config.getSecretKey());
